            ...
            <section className="paralax-mf footer-paralax bg-image sect-mt4 route" style={{backgroundImage: "url("+imageOverlay+")"}}>
                ...
                <div className="row">
                    ...
                    <div className="contact-mf">
                        ...
                        <div className="row">
                            ...
                            <div>
                                <form action="https://getform.io/f/bf882450-47a4-4391-b09b-00c9b021de31" method="POST" className="contactForm">
                            ...
                            <div className="more-info">
                                ...
                                <ul className="list-ico">
                                    <li><span className="ion-ios-location"></span> Sid, Serbia </li>
                                    {/* <a href="tel:+91-7021624827" ><li><span className="ion-ios-telephone"></span> +91-7021624827</li></a> */}
                                    <li><a href="mailto: pedjolinodev@gmail.com"><span className="ion-email"></span> </a> pedjolinodev@gmail.com</li>
                                    {/* <li><span class="ion-email"></span> shubh.as@somaiya.edu</li> */}
                                </ul>
                            </div>
                            <div className="socials">
                                <ul>
                                <li><a href="https://github.com/PredragWebDev" target="_blank" rel="noopener noreferrer"><span className="ico-circle"><i className="ion-social-github"></i></span></a></li>
                                <li><a href="https://www.linkedin.com/in/predrag-tomic-624241281/" target="_blank" rel="noopener noreferrer"><span className="ico-circle"><i className="ion-social-linkedin"></i></span></a></li>
                ...
                <div className="container">
                    ...
                    <div className="col-sm-12">
                        ...
                        <p className="copyright">2020 &copy; Copyright <strong>Predrag Tomic</strong>.</p>
                        </div>
                    </div>
                    </div>
                </div>
